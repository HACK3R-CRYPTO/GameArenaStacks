                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar text-gray-300 text-sm">
                    ...
                    <section>
                        ...
                        <div className="bg-white/5 p-4 rounded border-l-2 border-green-500">
                            <p className="mb-2">
                                <strong className="text-white">Arena AI Champion</strong> is a competitive 1v1 wagering platform where you challenge an Autonomous AI Agent on the Stacks Blockchain with x402 automated payments.
                            </p>
